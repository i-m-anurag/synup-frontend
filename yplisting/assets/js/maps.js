    ...
    "data": [
        {
            ...
            "desc": "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor adipisicing elit, sed do eiusmod tempor",
            "category": "Restourant",
            "review": 5,
            "rating": 4,
            "latitude": 51.541599,
...
function insertPropertyToArray(property, layout) {
    ...
    if (layout == 'grid_layout') {
        ...
        element = '<div class="listing-item-box-2" > ' +
            '   <div class="row"> ' +
            '       <div class="col-xl-4 col-lg-5 col-md-5 col-pad"> ' +
            '           <div class="listing-thumbnail"> ' +
            ...
            '           </div> ' +
            '       </div> ' +
            '       <div class="col-xl-8 col-lg-7 col-md-7 col-pad align-self-center"> ' +
            '           <div class="detail"> ' +
            '               <h3 class="title"> ' +
            '                   <a href="listing-single.html">' + title + '</a> ' +
            '               </h3> ' +
...
function generateMap(latitude, longitude, mapProvider, layout) {
    ...
    $.each(properties.data, function (index, property) {
        var icon = '<img src="src/assets/img/logos/black-logo.png">';
